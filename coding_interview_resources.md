This is a cleaned version of the resources found in the original repository. You **DO NOT** need to know this for the test. In fact, I would ignore this completly until after the test.
